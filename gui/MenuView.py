...
class Menu(QMainWindow, form_class):
    ...
    def showPaymentDialog(self, price):
        # self.simple_payment.setProduct()

        self.simple_payment.setPrice(price)
    ...
    class Simple_payment(QDialog, form_class2):
        ...
        def setPrice(self, price):
            self.product_price.setText(str(price))
        ...
        def setProduct(self, row_data):
            ...
            # self.product_name.setText(self.row_data['p_name'])
            # 상품 가격
            self.product_price.setText(str(self.total_price_label.text()))
